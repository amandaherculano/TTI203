...
(function dartProgram() {
  ...
  A = {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 4;
              return A._asyncAwait(A.promiseToFuture(A.JSAnyToObjectExtension_get_toObjectShallow(self.window.CanvasKitInit(t1._as({locateFile: A._functionToJS2(A._engine__canvasKitWasmModuleUrl$closure())}))), t1), $async$downloadCanvasKit);
            case 4:
              // returning from await.
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = 5;
              return A._asyncAwait(A._downloadCanvasKitJs(t3 == null ? t1._as(t3) : t3), $async$_downloadOneOf);
            case 5:
              // returning from await.
              if ($async$result) {
                // goto return
    ...
    _downloadCanvasKitJs(url) {
      var script, canvasKitLoadCompleter, loadCallback, errorCallback,
        t1 = A.configuration()._configuration;
      ...
      if (t1 != null)
        script.nonce = t1;
      script.src = A.ObjectToJSAnyExtension_get_toJSAnyShallow(A.createTrustedScriptUrl(url));
      ...
      loadCallback.set$finalLocalValue(A._functionToJS1(new A._downloadCanvasKitJs_loadEventHandler(script, canvasKitLoadCompleter)));
      errorCallback.set$finalLocalValue(A._functionToJS1(new A._downloadCanvasKitJs_errorEventHandler(script, canvasKitLoadCompleter)));
    ...
    _PointerAdapter_setup_closure: function _PointerAdapter_setup_closure() {
    },
    ...
    _PointerAdapter_setup_closure5: function _PointerAdapter_setup_closure5(t0) {
      this.$this = t0;
    },
  ...
  A._canvasKitJsUrls_closure.prototype = {
    call$1(filename) {
      ...
      return (t1 == null ? "https://www.gstatic.com/flutter-canvaskit/b8800d88be4866db1b15f8b954ab2573bba9960f/" : t1) + filename;
    },
    $signature: 19
  };
  A._downloadCanvasKitJs_loadEventHandler.prototype = {
    call$1(_) {
      ...
      this.canvasKitLoadCompleter.complete$1(true);
    },
    $signature: 1
  };
  A._downloadCanvasKitJs_errorEventHandler.prototype = {
    call$1(errorEvent) {
      this.canvasKitScript.remove();
      this.canvasKitLoadCompleter.complete$1(false);
    },
    $signature: 1
  };
  ...
  A.HtmlViewEmbedder.prototype = {
    _cleanUpClipDefs$1(viewId) {
      ...
      if (t1.containsKey$1(viewId)) {
        ...
        t3.toString;
        for (t4 = type$._DomListWrapper_JavaScriptObject, t4 = A.CastIterable_CastIterable(new A._DomListWrapper(t2.children, t4), t4._eval$1("Iterable.E"), type$.JavaScriptObject), t2 = t4._source, t2 = t2.get$iterator(t2), t4 = A._instanceType(t4)._rest[1]; t2.moveNext$0();) {
  ...
  A._PointerAdapter.prototype = {
    ...
    setup$0() {
      var t3, _this = this,
        t1 = _this._listeners,
        t2 = _this._owner.view;
      t1.push(A.Listener_Listener$register("touchstart", new A._PointerAdapter_setup_closure(), null, t2.get$dom().rootElement));
      _this._addPointerEventListener$3(t2.get$dom().rootElement, "pointerdown", new A._PointerAdapter_setup_closure0(_this));
      t3 = t2.embeddingStrategy;
      _this._addPointerEventListener$3(t3.get$globalEventTarget(), "pointermove", new A._PointerAdapter_setup_closure1(_this));
      _this._addPointerEventListener$4$checkModifiers(t2.get$dom().rootElement, "pointerleave", new A._PointerAdapter_setup_closure2(_this), false);
      _this._addPointerEventListener$3(t3.get$globalEventTarget(), "pointerup", new A._PointerAdapter_setup_closure3(_this));
      _this._addPointerEventListener$4$checkModifiers(t2.get$dom().rootElement, "pointercancel", new A._PointerAdapter_setup_closure4(_this), false);
      t1.push(A.Listener_Listener$register("wheel", new A._PointerAdapter_setup_closure5(_this), false, t2.get$dom().rootElement));
    },
  ...
  A._PointerAdapter_setup_closure5.prototype = {
    call$1($event) {
      var t1 = this.$this;
  ...
  A.FullPageEmbeddingStrategy.prototype = {
    ...
    _applyViewportMeta$0() {
      ...
      for (t1 = type$._DomListWrapper_JavaScriptObject, t1 = A.CastIterable_CastIterable(new A._DomListWrapper(self.document.head.querySelectorAll('meta[name="viewport"]'), t1), t1._eval$1("Iterable.E"), type$.JavaScriptObject), t2 = t1._source, t2 = t2.get$iterator(t2), t1 = A._instanceType(t1)._rest[1]; t2.moveNext$0();)
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "core_Uri_decodeComponent$closure", "Uri_decodeComponent", 19);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JavaScriptObject)", "bool(FlutterHtmlKeyboardEvent)", "~(int)", "Null(JavaScriptObject)", "~(@)", "~(Object,StackTrace)", "~(ByteData?)", "~(~())", "~(Object?,Object?)", "JSObject([JavaScriptObject?])", "Future<Null>()", "Future<~>()", "~(Uint8List,String,int)", "@()", "Null(@)", "@(@)", "List<JavaScriptObject>()", "Future<JavaScriptObject>([JavaScriptObject?])", "String(String)", "KeyData()", "~(bool)", "bool(KeyData)", "JavaScriptObject?(int)", "Null()", "JavaScriptObject?(double)", "int(JavaScriptObject)", "JSObject()", "Null(JavaScriptFunction,JavaScriptFunction)", "Null(Object?)", "Future<ServiceExtensionResponse>(String,Map<String,String>)", "FontAsset(@)", "FontFamily(@)", "Null(~)", "~(NativeUint8List)", "int()", "~(int,bool(FlutterHtmlKeyboardEvent))", "bool(int,int)", "~(ViewFocusEvent)", "RenderCanvas()", "~(JSArray<Object?>,JavaScriptObject)", "~(List<Object?>)", "Future<JavaScriptObject>()", "~(JavaScriptObject,List<PointerData>)", "~({allowPlatformDefault:bool})", "_ButtonSanitizer()", "String?(String)", "_PointerDeviceState()", "DateTime()", "bool(SemanticsObject)", "~(double)", "~(List<JavaScriptObject>,JavaScriptObject)", "Null(JSArray<Object?>,JavaScriptObject)", "~(Size?)", "String(Object?)", "@(@,String)", "@(String)", "MapEntry<int,String>(MapEntry<String,String>)", "~(Object?)", "Null(~())", "OffscreenCanvasViewRasterizer()", "Null(@,StackTrace)", "~(int,@)", "RegisteredFont?(ByteBuffer,String,String)", "Null(Object,StackTrace)", "_Future<@>(@)", "HotRestartCacheHandler?()", "Surface()", "~(String,int)", "~(String,int?)", "int(int,int)", "Uint8List(@,@)", "MultiSurfaceViewRasterizer()", "Object?(Object?)", "_Channel()", "String()", "String(int)", "Future<~>([JavaScriptObject?])", "String(String,String)", "~(AppLifecycleState)"],
